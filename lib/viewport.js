...
zb.device.platforms.tvip.ViewPort.prototype._initAspectRatioMap = function() {
	...
	var TVIPRatio = zb.platform.tvip.consts.player.TVIPPlayer.Ratio;
...
zb.device.platforms.tvip.ViewPort.prototype._findRatioInAspectRatioMap = function(ratio) {
	var supportedRatios = /** @type {Array.<zb.platform.tvip.consts.player.Ratio>} */ (Object.keys(this._aspectRatioMap));
...
/**
 * @type {!Object.<zb.platform.tvip.consts.player.TVIPPlayer.Ratio, zb.device.AspectRatio>}
 * @protected
 */
