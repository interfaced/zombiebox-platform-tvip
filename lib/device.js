...
zb.device.platforms.tvip.Device.prototype.createVideo = function() {
	return new zb.device.platforms.tvip.Video(this._tvipPlayer, this._tvipStb);
};
...
/** @inheritDoc */
zb.device.platforms.tvip.Device.prototype.hasOSDOpacityFeature = function() {
	return false;
};


/** @inheritDoc */
zb.device.platforms.tvip.Device.prototype.setOSDOpacity = function(value) {
	//todo need delete?
};
