 ...
 * @override
 */
zb.device.platforms.tvip.Device.prototype.createVideo = function(videoContainerRect) {
	return new zb.device.platforms.tvip.Video(videoContainerRect, this._tvipPlayer, this._tvipEvent, this._tvipStb);
};
 ...
 * @return {TVIPStb}
 */
zb.device.platforms.tvip.Device.prototype.getStbObject = function() {
