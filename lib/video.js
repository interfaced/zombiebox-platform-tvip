 ...
 * @param {zb.device.ViewPort.Rect} videoContainerRect
 ...
 */
zb.device.platforms.tvip.Video = function(videoContainerRect, tvipPlayer, tvipEvent, tvipStb) {
	...
	this._initViewPort(videoContainerRect, plugin);
	goog.base(this);
 ...
 * @private
 */
zb.device.platforms.tvip.Video.prototype._initViewPort = function(containerRect, plugin) {
	this._viewport = new zb.device.platforms.tvip.ViewPort(containerRect, plugin);
};
